...
public interface RoleResourceMapper {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    int batchInsertSelective(@Param("list") List<RoleResource> list, @Param("selective") RoleResource.Column ... selective);
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    int logicalDeleteByExample(@Param("example") RoleResourceExample example);
